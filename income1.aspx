<%@ Page Title="" Language="C#" MasterPageFile="~/Site2.Master" AutoEventWireup="true" CodeBehind="income1.aspx.cs" Inherits="Rudra.WebForm2" %>
                ...
                <div class="card shadow-lg rounded">
                    <div class="card-body">
                        ...
                        <div class="form-group mb-2 text-center">
                            <div class="row">
                                <div class="col">
                                    <asp:Button ID="Btnincome" runat="server" CssClass="btn btn-green btn-lg" Text="Income" OnClick="Btnincome_Click" />
                                </div>
                            </div>
                        </div>
                    </div>
